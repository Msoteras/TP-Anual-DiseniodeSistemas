...
public class UsuarioController extends Controller implements ICrudViewsHandler {
     ...
     private void asignarParametros(Usuario usuario, Context context) {
          ...
          if(context.formParams("horarios")!=null) {
               ...
               List<LocalTime> horariosSeleccionadosUsuario = new ArrayList<>();
               DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm");


               for (String str : horariosSeleccionados) {
                    LocalTime localTime = LocalTime.parse(str, formatter);
                    horariosSeleccionadosUsuario.add(localTime);
               }

               usuario.setHorariosDisponibles(horariosSeleccionadosUsuario);
          }
